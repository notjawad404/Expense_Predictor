...
def recommend():
    ...
    x1_prediction = lin_reg.predict(scaler.transform(poly.transform([[0]])))[0]  # Transport
    x2_prediction = lin_reg.predict(scaler.transform(poly.transform([[1]])))[0]  # Food
    x3_prediction = lin_reg.predict(scaler.transform(poly.transform([[2]])))[0]  # Education
    x4_prediction = lin_reg.predict(scaler.transform(poly.transform([[3]])))[0]  # Transfer
